...
public:
     ...
     */
    Spot(std::time_t date, double open, double high, double low, double close, double adj_close);
     ...
     * @param close Price at closing
     */
    Spot(std::string date, double open, double high, double low, double close, double adj_close);
